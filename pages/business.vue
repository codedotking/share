<template>
  <div class="h-screen grid grid-cols-3 divide-x">
    <div class="h-screen flex flex-col col-span-2 bg-slate-100">
      ...
      <div class="border-t bg-white flex items-center">
        ...
        <a
          href="https://github.com/huala-fun/share"
          target="_blank"
          class="h-12 flex items-center space-x-2 px-4 border-r text-xs font-medium bg-white text-slate-700"
        >
          <span> Github </span>
...
const publish = () => {
  const url = `${window.location.origin}/business-card?data=${encodeData(data.value)}`;
